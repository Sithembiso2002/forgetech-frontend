...
const socialLinks = [
  { icon: FacebookIcon, href: "https://www.facebook.com/profile.php?id=61574330018362", label: "Facebook" },
  { icon: InstagramIcon, href: "https://www.instagram.com/forgetechnobles", label: "Instagram" },
...
const mainNavLinks: NavItem[] = [
  ...
  { label: "About US", href: "/about", icon: FolderOpen, description: "learn about forgetech" },
